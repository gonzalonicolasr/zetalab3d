-- ========================================
-- ZETALAB Admin Management Database Setup (FIXED)
...
-- 12. Update existing policies for other tables to recognize admins
...
CREATE OR REPLACE FUNCTION public.create_admin_user(
  ...
  admin_permissions JSONB DEFAULT '{"users":true,"subscriptions":true,"analytics":true,"admin_management":true}',
